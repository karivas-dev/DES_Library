...
namespace library.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,PublishingDate,AuthorId,CategoryId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,PublishingDate,AuthorId,CategoryId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
